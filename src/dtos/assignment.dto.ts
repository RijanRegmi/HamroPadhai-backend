...
export const createAssignmentDTO = z.object({
  ...
  dueDate: z.string().min(1, "Due date is required"), // Accept ISO string
  assignedTeacherId: z.string().min(1, "Assigned teacher is required"), // ✅ REQUIRED (removed .optional())
...
export const updateAssignmentDTO = z.object({
  ...
  assignedTeacherId: z.string().optional(), // Optional for updates
  attachments: z.array(z.object({
    fileName: z.string(),
    fileUrl: z.string(),
    fileType: z.string(),
